            ...
            <TableContainer>
              <Table>
                <TableHead sx={{ bgcolor: 'rgba(0,0,0,0.02)' }}>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 600, color: 'var(--color-text-primary)', width: '20%' }}>
                      Código
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, color: 'var(--color-text-primary)', width: '45%' }}>
                      Producto
                    </TableCell>
                    <TableCell sx={{ fontWeight: 600, color: 'var(--color-text-primary)', width: '25%' }}>
                      Precio
                    </TableCell>
          ...
          <TableContainer>
            <Table>
              <TableHead sx={{ bgcolor: 'rgba(0,0,0,0.02)' }}>
                <TableRow>
                  <TableCell
                    sx={{ fontWeight: 600, color: 'var(--color-text-primary)', cursor: 'pointer', width: '20%', '&:hover': { bgcolor: 'rgba(0,0,0,0.04)' } }}
                    onClick={() => handleRequestSort('code')}
                  >
                    Código <ArrowDropDownIcon sx={{ fontSize: 16, verticalAlign: 'middle' }} />
                  </TableCell>
                  <TableCell
                    sx={{ fontWeight: 600, color: 'var(--color-text-primary)', cursor: 'pointer', width: '45%', '&:hover': { bgcolor: 'rgba(0,0,0,0.04)' } }}
                    onClick={() => handleRequestSort('name')}
                  >
                    Producto <ArrowDropDownIcon sx={{ fontSize: 16, verticalAlign: 'middle' }} />
                  </TableCell>
                  <TableCell
                    sx={{ fontWeight: 600, color: 'var(--color-text-primary)', width: '25%', cursor: 'pointer', '&:hover': { bgcolor: 'rgba(0,0,0,0.04)' } }}
                    onClick={() => handleRequestSort('price')}
                  >
                    Precio <ArrowDropDownIcon sx={{ fontSize: 16, verticalAlign: 'middle' }} />
                  </TableCell>
